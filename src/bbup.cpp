...
int main(int argc, char* argv[]) {
	...
	desc.add_options()
		...
		("encrypt", po::value<bool>(&encrypt)->default_value(false), "Encrypt on remote")
		("encrypt-pass", po::value<std::string>(&encrypt_pass)->default_value(""), "Password to use for encrypting on remote, implies --encrypt")
	;
